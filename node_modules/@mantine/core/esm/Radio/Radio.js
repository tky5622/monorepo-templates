...
const Radio = forwardRef((props, ref) => {
  ...
  const { classes, cx } = useStyles({ color, size: (ctx == null ? void 0 : ctx.size) || size, transitionDuration, labelPosition, error: !!error }, { classNames, styles, unstyled, name: "Radio" });
