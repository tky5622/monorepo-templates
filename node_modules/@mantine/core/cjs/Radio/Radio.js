...
const Radio = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = Radio_styles['default']({ color, size: (ctx == null ? void 0 : ctx.size) || size, transitionDuration, labelPosition, error: !!error }, { classNames, styles: styles$1, unstyled, name: "Radio" });
