...
function copyPackageJson(_options, context) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { target, dependencies, projectRoot } = (0, check_dependencies_1.checkDependencies)(context, context.target.options.tsConfig);
        const options = Object.assign(Object.assign({}, _options), { projectRoot });
        if ((_a = options.extraDependencies) === null || _a === void 0 ? void 0 : _a.length) {
            dependencies.push(...options.extraDependencies);
        }
        if (options.watch) {
            const dispose = yield (0, watch_for_single_file_changes_1.watchForSingleFileChanges)((0, path_1.join)(context.root, projectRoot), 'package.json', () => (0, update_package_json_1.updatePackageJson)(options, context, target, dependencies));
