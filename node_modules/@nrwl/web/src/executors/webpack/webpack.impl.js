...
function webpackExecutor(options, context) {
    return tslib_1.__asyncGenerator(this, arguments, function* webpackExecutor_1() {
        yield tslib_1.__await(yield* tslib_1.__asyncDelegator(tslib_1.__asyncValues((0, webpack_1.webpackExecutor)(Object.assign(Object.assign({}, options), { target: 'web' }), context))));
    });
}
