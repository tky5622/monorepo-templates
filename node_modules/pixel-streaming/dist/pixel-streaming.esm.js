import { useReducer, useCallback, useRef, useEffect, useState, createElement, useContext, createContext, forwardRef, useImperativeHandle, Fragment } from 'react';
import CustomProvider from 'rsuite/CustomProvider';
import { ControlSchemeType, Logger as Logger$1, DelegateBase, ActionOverlay, AfkOverlay, InstanceState, MessageAuthResponseOutcomeType, EventsClass as EventsClass$1, webRtcPlayerController, Config } from 'unreal-pixel-streaming';
...
import { faVolumeHigh, faVolumeOff, faExpand, faQrcode, faCompress, faPlay, faPause, faStar, faSquareCaretLeft, faSquareCaretRight, faSquareCaretUp, faSquareCaretDown, faQuestion } from '@fortawesome/free-solid-svg-icons';
    ...
    if (toggleElement) {
      ...
      toggleElement.onchange = function () {
        if (toggleElement.checked === true) {
          ...
          _this9.config.controlScheme = ControlSchemeType.HoveringMouse;

          _this9.iWebRtcController.activateRegisterMouse();
        } else {
          _this9.controlSchemeToggleTitle.innerHTML = "Control Scheme: Locked Mouse";
          _this9.config.controlScheme = ControlSchemeType.LockedMouse;
...
var ClientClass = /*#__PURE__*/function () {
  ...
  _proto.init = function init() {
    ...
    var CreateConfig = function CreateConfig(signalingAddress, playerElement) {
      var config = new Config(signalingAddress, playerElement); // Config performer
      ...
      Config._enableVerboseLogging = getCfg('enableVerboseLogging', false);
      config.enableSpsAutoplay = getCfg('enableSpsAutoplay', true);
      config.startVideoMuted = getCfg('startVideoMuted', false);
      config.controlScheme = getCfg('controlScheme', ControlSchemeType.HoveringMouse);
    ...
    function create(config, delegate) {
      return new webRtcPlayerController(config, delegate);
    }
...
var useDispatch = function useDispatch() {
  ...
  var eventCommand = useCallback(function (_ref) {
  ...
  var eventCallbacks = useCallback(function (_ref2) {
  ...
  var eventMouse = useCallback(function (_ref3) {
  ...
  var eventWebrtcStatus = useCallback(function (_ref4) {
    var detail = _ref4.detail;
    cls.updateWebrtcData(detail);
  }, [state]);
  var eventUeSettingsInitial = useCallback(function (_ref5) {
...
var useBuildConnector = function useBuildConnector(dispatch) {
  ...
  var cls = new ( /*#__PURE__*/function () {
    ...
    _proto.removeSession = function removeSession() {
      Logger$1.infoLog('Remove session & reinit');
...
var useNotifier = function useNotifier() {
  var refCommand = useRef(null);
  var refCallback = useRef(null);
  var cls = new ( /*#__PURE__*/function () {
    function _class() {}
    ...
    _proto.pushCommand = function pushCommand(placement, event) {
      ...
      var message = createElement(Notification, {
        type: undefined,
...
var useResolution = function useResolution(ConsoleSettings) {
  var refTimer = useRef(null); // Initialize state with undefined width/height so server and client renders match
...
var useUnload = function useUnload(fn) {
  var cb = useRef(fn); // init with fn, so that type checkers won't assume that current might be undefined
...
var useActions$1 = function useActions() {
  ...
  var refTimeoutConfig = useRef(null); //hack
...
var Provider$1 = function Provider(props) {
  ...
  return createElement(AppContext$1.Provider, {
    value: actions
  }, props.children);
};
...
var ContextProvider = function ContextProvider(props) {
  return createElement(CustomProvider, {
    theme: 'dark'
  }, createElement(Provider, null, createElement(Provider$1, null, props.children)));
};
...
var DebugPanel = function DebugPanel(props) {
  ...
  return createElement("div", {
  ...
  }, createElement("div", null, "Pre Stream Options")), createElement("div", {
    className: "row"
  }, createElement("div", {
    className: "col-sm"
  }, createElement("label", {
    ...
    className: "settings-text"
  }, createElement("div", null, "Viewing")), createElement("div", {
  ...
  }, "Enlarge display to fill window")), createElement("div", {
    className: "form-check form-switch col-auto"
  }, createElement("input", {
    className: "form-check-input",
    type: "checkbox",
  ...
  }, "Is Quality Controller")), createElement("div", {
    className: "form-check form-switch col-auto"
  }, createElement("input", {
    className: "form-check-input",
    type: "checkbox",
  ...
  }, "Match viewport resolution")), createElement("div", {
    className: "form-check form-switch col-auto"
  }, createElement("input", {
    className: "form-check-input",
    type: "checkbox",
    ...
    id: "commandsHeader",
    className: "settings-text"
  }, createElement("div", null, "Commands")), createElement("div", {
    ...
    className: "settings-text"
  }, "UI Descriptor")), createElement("div", {
    className: "col col-auto"
  }, createElement("input", {
    type: "text",
    ...
    className: "settings-text"
  }, createElement("div", null, "Settings")), createElement("div", {
    ...
    className: "col-sm"
  }, createElement("div", null, "Encoder Settings"), createElement("div", {
    id: "encoderSettings",
    className: "col"
  }, createElement("div", {
    className: "form-group row"
    ...
    className: "col-sm"
  }, createElement("div", null, "WebRTC Settings"), createElement("div", {
    id: "webrtcSettings"
  }, createElement("div", {
    className: "form-group row"
  }, createElement("label", {
    htmlFor: "webrtc-fps-text"
  }, "FPS"), createElement("input", {
    type: "number",
    className: "form-control form-control-sm",
    id: "webrtc-fps-text",
    defaultValue: "0",
  ...
  }, "Min bitrate (bps)"), createElement("input", {
    type: "number",
    className: "form-control form-control-sm",
  ...
  }, "Max bitrate (bps)"), createElement("input", {
    type: "number",
    className: "form-control form-control-sm",
    ...
    id: "statisticsHeader",
    className: "settings-text"
  }, createElement("div", null, "Statistics")), createElement("div", {
    ...
    id: "control-scheme-title"
  }, "Send to server")), createElement("div", {
    className: "form-check form-switch col-auto"
  }, createElement("input", {
    className: "form-check-input",
    type: "checkbox",
    ...
    className: "settings-text"
  }, createElement("div", null, "Latency Test"), createElement("input", {
...
var CustomDrawer = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return createElement(Drawer, {
    ...
    open: open,
    onClose: handleClose
  }, createElement(Drawer.Header, {
    className: classes.header
  }, typeof config.title === 'string' ? createElement(Drawer.Title, null, config.title) : config.title, props.ActionsComponent ? createElement(Drawer.Actions, {
    style: {
      marginRight: -20
    }
  }, props.ActionsComponent) : ''), createElement("div", {
    onWheel: function onWheel(e) {
      e.stopPropagation();
    },
...
var Panel = function Panel() {
  ...
  return createElement("div", null, createElement(JsonViewer, {
    data: renderState()
  }));
};
...
var CommandsList = function CommandsList(props) {
  ...
  var renderCommandsList = function renderCommandsList() {
    ...
    return createElement("div", null, group_list.map(function (group, index) {
      return createElement("ul", {
        key: index,
        className: classes.groupList
      }, createElement("li", null, group.name, " (", group.group, ")"), createElement("li", null, group.items.map(function (item, i) {
        var status = false;
  ...
  return createElement("div", null, renderCommandsList());
};

var Panel$2 = function Panel() {
  var system = useSystem();
  return createElement("div", null, createElement(CommandsList, {
...
var Panel$3 = function Panel() {
  ...
  }, "Start / stop"), createElement(CommandsList, {
...
var Panel$4 = function Panel() {
  ...
  }, "Clear"), createElement(JsonViewer, {
...
var NotificationsSettings = function NotificationsSettings() {
  ...
  return createElement("div", null, message, createElement(ButtonToolbar, null, createElement(SelectPicker, {
    value: data.type,
    data: [{
      label: 'Test command',
      value: 'info'
  ...
  }, "Push")), createElement(ButtonToolbar, null, createElement(Button, {
    onClick: function onClick() {
...
var Panel$6 = function Panel() {
  var system = useSystem();
  return createElement("div", null, createElement(Form.Group, null, createElement(Form.ControlLabel, null, "System Notifications"), createElement("div", {
    style: {
      display: 'flex',
      gap: 5,
      paddingTop: 10
  ...
  }, createElement(NotificationsSettings, null)));
};

var Panel$7 = function Panel() {
  return createElement("div", null, createElement(DebugPanel, null));
};

var DevMenu = function DevMenu(props) {
  var refDrawer = useRef(null);
  var system = useSystem();
  var menuList = [['Player Data', 'playerData', createElement(ListIcon, null), createElement(Panel, null)], ['Meta Data', 'metaData', createElement(ListIcon, null), createElement(Panel$1, null)], ['Menu: system', 'menuSystem', createElement(ProjectIcon, null), createElement(Panel$3, null)], ['Menu: project', 'menuProject', createElement(ProjectIcon, null), createElement(Panel$2, null)], ['History: commands', 'historyCommands', createElement(HistoryIcon, null), createElement(Panel$4, null)], ['History: callbacks', 'historyCallbacks', createElement(HistoryIcon, null), createElement(Panel$5, null)], ['Settings', 'settings', createElement(SettingIcon, null), createElement(Panel$6, null)], ['Pixel Streaming', 'pixelStreaming', createElement(PlayOutlineIcon, null), createElement(Panel$7, null)]].map(function (_ref) {
    var label = _ref[0],
        slug = _ref[1],
        Icon = _ref[2],
        Component = _ref[3];
  ...
  return createElement("div", null, createElement(CustomDrawer, {
    ...
    defaultOpenKeys: ['3', '4']
  }, createElement(Sidenav.Body, null, createElement(Nav, null, menuList.map(function (item, index) {
    return createElement(Nav.Item, {
      key: index,
      icon: createElement(Fragment, null, item.Icon),
...
var CustomModal = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return createElement(Modal, {
    open: open,
    onClose: handleClose
  }, createElement(Modal.Header, null, createElement(Modal.Title, null, props.title)), createElement(Modal.Body, null, props.children), showFooter && createElement(Modal.Footer, null, props.FooterComponent || createElement(Fragment, null, createElement(Button, {
...
var Actions = function Actions() {
  ...
  return createElement("div", null, createElement(CustomModal, {
    title: "Api Connector",
    onSuccess: undefined,
    onClose: undefined,
    FooterComponent: createElement(Fragment, null, createElement(Button, {
      onClick: function onClick() {
        window.open(config.portal.urlProjects);
      }
    }, "My Projects"), createElement(Button, {
      disabled: disabled,
  ...
  }, "Copy your Api Key from ", createElement("a", {
    href: config.portal.urlProjects,
    target: "_blank"
  }, config.portal.name)), createElement("form", {
  ...
  }, error)))), system.cls.apiKeyIsCorrect ? createElement(Button, {
    color: 'green',
    appearance: 'ghost',
    onClick: handleOpen
  }, "Reconnect Project") : createElement(Button, {
    color: 'red',
    appearance: 'primary',
    onClick: handleOpen
  }, "Connect Project"));
...
var DevBar = function DevBar() {
  ...
  useHotkeys('ctrl+z', function (e) {
    if (!e.repeat) {
      openDrawer();
      return;
    }
  }, []);
  return createElement("div", null, createElement(IconButton, {
    onClick: function onClick() {
      return openDrawer();
    },
    icon: createElement(GearIcon, null),
    circle: true,
    size: "lg"
  }), createElement(CustomDrawer, {
    onClose: function onClose() {
      system.dispatch.updateDevBar({
        slug: null
      });
    ...
    }, createElement("li", null, createElement("h6", null, "MetaEditor")), createElement("li", null, createElement("span", null, "v", config.version))),
    ActionsComponent: createElement(Actions, null)
  }, createElement("div", null, createElement(UpdateMessage, null), createElement(DevMenu, {
    onClose: function onClose() {
      setDrawerSlug();
    }
  }))));
...
var PlayerOverlay = function PlayerOverlay() {
  ...
  var renderContent = function renderContent() {
    ...
    if (_playError) {
      return createElement(Progress.Circle, Object.assign({}, eProps, {
        status: 'fail'
      }));
  ...
  var renderStatus = function renderStatus() {
    ...
    }, status, " ", _isPending && percent > 0 ? time : ''), system.config.issuesUrl ? createElement("div", {
      onClick: function onClick() {
...
var QrCode = function QrCode(props) {
  ...
  return createElement("div", null, createElement(ReactQRCode, {
    level: props.level,
...
var useStyles$5 = /*#__PURE__*/createUseStyles({
  root: {
    backgroundColor: '#fff',
    padding: '60px 30px',
    display: 'flex',
...
var ShareLink = function ShareLink() {
  ...
  }, "Copy the address or scan the QR code with your phone."), createElement(InputGroup, {
    size: 'lg'
  }, createElement(Input, {
    readOnly: true,
    defaultValue: sharedUrl || ''
  }), createElement(InputGroup.Button, {
    onClick: function onClick() {
      return copy.text(sharedUrl);
    }
  }, createElement(CopyIcon, null))), createElement("div", {
    className: classes.root
  }, createElement(QrCode, {
    value: sharedUrl
  })))), createElement(SvgIcon, {
    disabled: !sharedUrl,
    button: true,
    buttonSize: 'lg',
    name: 'qrcode',
...
var useStyles$6 = /*#__PURE__*/createUseStyles({
  popover: {
    width: 150,
    padding: 10
  }
...
var VolumeButton = function VolumeButton() {
  ...
  return createElement("div", null, createElement(Whisper, {
    ref: refWhisper,
    placement: "left",
    trigger: "hover",
    enterable: true,
  ...
  }, createElement("div", null, createElement(SvgIcon, {
    button: true,
    buttonSize: 'lg',
...
var useNotify = function useNotify() {
  var message = new ( /*#__PURE__*/function () {
    ...
    _proto.push = function push(children, options, settings) {
      var message = createElement(Message, Object.assign({}, options), children);
...
var useStyles$7 = /*#__PURE__*/createUseStyles({
  content: {},
  keysList: {
    marginBottom: 20,
    width: 230,
  ...
  var renderContent = function renderContent() {
    ...
    return createElement("div", {
      ...
      return createElement("li", {
        key: index
      }, createElement("label", null, item.label), createElement("div", null, "Press \"", item.key, "\" or ", createElement(SvgIcon, {
        name: item.icon,
        size: 20
      })));
    })), createElement(Button, {
...
var PlayerActions = function PlayerActions() {
  ...
  return createElement(Fragment, null, createElement(SvgIcon, {
    button: true,
    buttonSize: 'lg',
  ...
  }), createElement(VolumeButton, null), createElement(SvgIcon, {
    button: true,
    buttonSize: 'lg',
  ...
  }), createElement(ShareLink, null), createElement(Helpers.KeyboardHelper, null));
};
...
var useMedia = function useMedia() {
  ...
  var _React$useState = useState(defaultSizes),
...
var _div, _root;
var useStyles$8 = /*#__PURE__*/createUseStyles({
  root: (_root = {
    position: 'fixed',
    left: 0,
    right: 0,
...
var MenuPopover = /*#__PURE__*/forwardRef(function (_ref2, ref) {
  ...
  return createElement(Popover, Object.assign({
    ref: ref
  }, rest, {
    full: true
  }), createElement(Dropdown.Menu, null, items.map(function (item, index) {
    return createElement(Dropdown.Item, {
      key: index,
      onClick: function onClick() {
        item.onClick();
        onClose();
    ...
    }, item.preview_small ? createElement("img", {
      src: item.preview_small
    }) : '', item.name));
  })));
});
var Panel$8 = /*#__PURE__*/forwardRef(function (props, ref) {
  var system = useSystem();
  var player = usePlayer();
  ...
  var renderMobileMenu = function renderMobileMenu() {
    ...
    return createElement("div", null, createElement("ul", {
      ...
      "data-li": "logo"
    }, system.project.name), createElement("li", {
      "data-li": "menu"
    }, createElement("ul", {
      ...
      if (item.subitems.length > 0) {
        return createElement("li", {
          ...
          speaker: createElement(MenuPopover, {
            items: item.subitems,
            onClose: closeMobileMenu
          })
        }, createElement("label", null, item.name)));
      }
  ...
  var renderContent = function renderContent() {
    ...
    }, createElement("strong", null, system.project.name)), createElement(Nav, {
      ...
      if (item.subitems.length > 0) {
        return createElement(Dropdown, {
          ...
          return createElement(Dropdown.Item, {
            ...
            className: classes.dropdownItem
          }, subitem.preview_small ? createElement("img", {
  ...
  return createElement("div", {
    className: classes.root
  }, createElement("div", null, createElement("div", Object.assign({}, props, {
    ref: ref
...
var QuickMenu = function QuickMenu() {
  ...
  return createElement(Animation.Slide, {
    "in": true,
    placement: 'bottom'
  }, function (props, ref) {
    return createElement(Panel$8, Object.assign({}, props, {
      ref: ref
    }));
  });
};

var useStyles$9 = /*#__PURE__*/createUseStyles({
  progressRoot: {
    position: 'absolute',
    zIndex: 1050 - 10,
    top: 27,
...
var useStyles$a = /*#__PURE__*/createUseStyles( /*#__PURE__*/_extends({}, global, {
  root: {
    margin: 0,
...
var Player = function Player(props) {
  ...
  return createElement("div", {
    ...
    isFirst: true
  }), system.config.showOverlay && createElement(PlayerOverlay, null), system.config.showQuickMenu && createElement(QuickMenu, null), createElement(ProgressKiller, null), (system.config.showToolbar || system.config.showDevBar) && createElement("div", {
    className: classes.toolbar,
    id: "metaeditor-toolbar"
  }, system.config.showDevBar && createElement(DevBar, null), system.config.showToolbar && createElement(PlayerActions, null)));
};

export { ContextProvider, CustomDrawer, CustomModal, Player, Request, SvgIcon, colors, config, media, useMedia, usePlayer, useStorage, useSystem };
