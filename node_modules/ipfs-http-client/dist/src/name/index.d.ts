...
export function createName(config: import('../types').Options): {
    publish: (path: string | import("multiformats/cid.js").CID, options?: (import("ipfs-core-types/src/name/index.js").PublishOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<import("ipfs-core-types/src/name/index.js").PublishResult>;
